...
<body>
    <div class="container-fluid main">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        <li class="nav__item"><a href="#" class="nav__link"><i
                                    class="ri-arrow-right-up-line"></i><span>Inicio</span></a></li>
                        <li class="nav__item"><a href="{{ url('/catalogue') }}" class="nav__link"><i
                                    class="ri-arrow-right-up-line"></i><span>Productos</span></a></li>
                        <li class="nav__item"><a href="#" class="nav__link"><i
                                    class="ri-arrow-right-up-line"></i><span>Sobre nosotras</span></a></li>
                        <li class="nav__item"><a href="#" class="nav__link"><i
                                    class="ri-arrow-right-up-line"></i><span>Contacto</span></a></li>
                    </ul>

                    <div class="nav__social d-flex gap-2 align-items-center">
                        @auth
                            <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                @csrf
                                <button class="button sign">Cerrar Sesión</button>
                            </form>

                            <a href="{{ url('/admin/main') }}" class="nav__social-link">
                                <button type="button" class="button register">Ir al Panel</button>
                            </a>
                        @else
        ...
        <div class="main-text position-absolute top-50 start-0 translate-middle-y ps-5">
            <h2>Encendemos momentos <br> Iluminamos emociones</h2>
            <p>Descubre la magia de nuestras velas <br> hechas a mano</p>
            ...
            <div class="row">
                <div class="col-6 col-md-2 mb-3">
                    ...
                    <ul class="flex-column">
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Nuevos
                                productos</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Más
                                vendidos</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Vistos
                                recientemente</a></li>
                        <li class="nav-item mb-2"><a href="#"
                                class="nav-link p-0 text-body-secondary">Populares de
                                esta semana</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Todos
                                los
                                productos</a></li>
                    </ul>
                </div>
                ...
                <div class="col-6 col-md-2 mb-3">
                    ...
                    <ul class="flex-column">
                        <li class="nav-item mb-2"><a href="#"
                                class="nav-link p-0 text-body-secondary">Velas</a>
                        </li>
                        <li class="nav-item mb-2"><a href="#"
                                class="nav-link p-0 text-body-secondary">Cosmética
                                natural</a></li>
                        <li class="nav-item mb-2"><a href="#"
                                class="nav-link p-0 text-body-secondary">Paquetes</a>
                        </li>
                </div>
                ...
                <div class="col-6 col-md-2 mb-3">
                    ...
                    <ul class="flex-column">
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Sobre
                                nosotras</a></li>
                        <li class="nav-item mb-2"><a href="#"
                                class="nav-link p-0 text-body-secondary">Contactanós</a></li>
                        <li class="nav-item mb-2"><a href="#"
                                class="nav-link p-0 text-body-secondary">Privacidad</a></li>
                    </ul>
                </div>

                <div class="col-md-5 offset-md-1 mb-3">
                    <form>
                        <h5>Recibe las últimas noticias, los últimos productos y consejos sobre como utilizar nuestras
                            velas
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                ...
                <ul class="list-unstyled d-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                        class="bii bi-facebook" viewBox="0 0 16 16">
                        <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                        class="bii bi-pinterest" viewBox="0 0 16 16">
                        <path
