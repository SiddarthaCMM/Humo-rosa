        ...
        <nav
            ...
            @else
                <div class="col-md-3 text-end">
                    <button type="button" class="btn svg btn-outline-primary me-2"><svg xmlns="http://www.w3.org/2000/svg"
                            width="16" height="16" fill="#A57268" class="bi bi-search-heart" viewBox="0 0 16 16">
