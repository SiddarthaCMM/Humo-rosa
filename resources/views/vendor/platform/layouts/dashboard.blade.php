...
@section('body-left')
    <div class="aside col-xs-12 col-md-2 bg-dark">
        <div class="d-md-flex align-items-start flex-column d-sm-block h-full">
            ...
            <div style="color: red; font-weight: bold;">ESTO ES UNA PRUEBA</div>
                ...
                <a class="header-brand order-last text-white" href="{{ route('platform.index') }}">
                    <div class="d-flex align-items-center">
                        <x-orchid-icon path="orchid" class="me-2" />
                        <div>
                            <strong class="text-white">Humo Rosa</strong><br>
